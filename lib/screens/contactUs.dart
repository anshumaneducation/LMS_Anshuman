                    ...
                    child: Column(children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Container(
                          padding: const EdgeInsets.all(8.0),
                          child: new Text(
                            'ANSHUMAN Tech Pvt. Ltd./n Plot 13, Sthairya, Behind Tol Hospital,\nNear Nav-Sahyadri Society, Karve Nagar,\nPune – 411 052 (MH) INDIA. Tel : (0091)(020) 25460892/ 25463052.\n\nmail us at : support@anshumantech.net',
                            style: TextStyle(color: primaryBar, fontSize: 15),
